...
exports.testEmailService = exports.sendWelcomeEmail = exports.sendResetSuccessEmail = exports.sendResetPasswordEmail = exports.sendVerificationEmail = void 0;
...
transporter.verify((error, success) => {
    if (error) {
        logger_js_1.logger.error('Email service configuration error:', error);
    }
    else {
        logger_js_1.logger.info('Email service is ready to send messages');
    }
});
// Common email styles
...
const sendVerificationEmail = async (email, verificationToken) => {
    try {
      ...
      `,
        ...
        logger_js_1.logger.info('Verification email sent:', info.messageId);
        return { success: true, messageId: info.messageId };
    }
    catch (error) {
        logger_js_1.logger.error('Error sending verification email:', error);
...
const sendResetPasswordEmail = async (email, resetToken) => {
    try {
      ...
      `,
        ...
        const info = await transporter.sendMail(mailOptions);
        logger_js_1.logger.info('Password reset email sent:', info.messageId);
        return { success: true, messageId: info.messageId };
    }
    catch (error) {
        logger_js_1.logger.error('Error sending password reset email:', error);
...
const sendResetSuccessEmail = async (email, firstName) => {
    try {
      ...
      `,
        ...
        const info = await transporter.sendMail(mailOptions);
        logger_js_1.logger.info('Password reset success email sent:', info.messageId);
        return { success: true, messageId: info.messageId };
    }
    catch (error) {
        logger_js_1.logger.error('Error sending password reset success email:', error);
...
const sendWelcomeEmail = async (email, firstName) => {
    try {
      ...
      `,
        ...
        const info = await transporter.sendMail(mailOptions);
        logger_js_1.logger.info('Welcome email sent:', info.messageId);
        return { success: true, messageId: info.messageId };
    }
    catch (error) {
        logger_js_1.logger.error('Error sending welcome email:', error);
...
const testEmailService = async () => {
    try {
      ...
      `,
        ...
        logger_js_1.logger.info('Test email sent successfully:', info.messageId);
        return { success: true, messageId: info.messageId };
    }
    catch (error) {
        logger_js_1.logger.error('Email service test failed:', error);
